...
export default function UpdateAttributeForm({
  ...
  const onSubmit = (data) => {
    ...
    makePutRequest(`api/attributes/${id}`, data, "Attribute", redirect, reset)
.then(() => {
      ...
      .catch((error) => {
        ...
        toast.error("Error updating Attribute. Please try again.");
      });
  };
              ...
              <div className="relative p-4 w-full max-w-md max-h-full mx-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  >
                    ...
                    <button
                      onClick={() => toast.success("New Attribute Added")}
