...
export default function UpdateCommunityForm({
  ...
  const onSubmit = (data) => {
    ...
    makePutRequest(`api/trainings/${id}`, data, "Community", redirect, reset)
.then(() => {
      ...
      .catch((error) => {
        ...
        toast.error("Error updating Community. Please try again.");
      });
  };
              ...
              <div className="relative p-4 w-full max-w-md max-h-full mx-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  >
                    ...
                    <button
                      onClick={() => toast.success("New Community Added")}
