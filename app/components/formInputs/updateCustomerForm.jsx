...
const UpdateCustomerForm = ({ heading, href, linktitle, updateData = {} }) => {
                  ...
                  >
                    <div className="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div className="col-span-2">
                        ...
                        />
                        {errors.email && (
                          <p className="text-red-600">Seller email is required</p>
                        )}
                      </div>
                    ...
                    <button
                      ...
                      className="relative shadow inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-blue-600 rounded-lg group bg-gradient-to-br from-blue-600 to-blue-500 hover:text-white dark:text-white"
                    >
