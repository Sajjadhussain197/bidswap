...
export default function NewSeller({ heading, href, linktitle, users }) {
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(false);
  const { reset,register, handleSubmit, formState: { errors } } = useForm(defaultValues={...users});
  ...
  const onSubmit = (data) => {
    ...
    makePostRequest('api/sellers', data, 'Seller', reset)
      .then(() => {
  ...
  <div className="grid gap-4 mb-4 grid-cols-2">
    ...
    <div className="col-span-2">
      ...
      <input
        ...
        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        placeholder="Type seller number"
      />
      {errors.name && <p className="text-red-600">Number is required</p>}
    </div>
    ...
    <div className="col-span-2 sm:col-span-1">
      ...
      >
        ...
        <option value="Barterer">Barterer</option>
      </select>
    </div>
    ...
    <div className="col-span-2">
      ...
      <textarea
        ...
        placeholder="Write seller address here"
      />
      {errors.description && <p className="text-red-600">Address is required</p>}
    </div>
    ...
    <div className="mb-4">
                    <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Seller Image</label>
                    <input
                      type="file"
                      id="imageUrl"
                      name="imageUrl"
  ...
  <button onClick={() =>   toast.success("New Category Added")} className="relative shadow inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-400 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
