...
export default function MarketPart({ heading, href, linktitle }) {
  ...
  const onSubmit = (data) => {
    ...
    makePostRequest("api/markets", data, "Market", reset)
      .then(() => {
      ...
      .catch((error) => {
        ...
        toast.error("Error adding market. Please try again.");
      });
  };
              ...
              <div className="relative p-4 w-full max-w-md max-h-full mx-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  >
                    ...
                    <button
                      onClick={() => toast.success("New Market Added")}
