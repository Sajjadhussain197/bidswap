...
export default function BannerPart({ heading, href, linktitle }) {
  ...
  const onSubmit = (data) => {
    ...
    makePostRequest('api/banners', data, 'Banner', reset)
      .then(() => {
  ...
  <div className="grid gap-4 mb-4 grid-cols-2">
    <div className="col-span-2">
      ...
      />
      {errors.name && <p className="text-red-600">Banner name is required</p>}
    </div>
    ...
    <div className="col-span-2">
      ...
      />
      {errors.description && <p className="text-red-600">Banner description is required</p>}
    </div>
  ...
  <button onClick={() =>   toast.success("New Banner Added")} className="relative shadow inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-400 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
