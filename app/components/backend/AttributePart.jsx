...
export default function AttributePart({ heading, href, linktitle }) {
  ...
  const onSubmit = (data) => {
    ...
    makePostRequest('api/attributes', data, 'Attribute', reset)
      .then(() => {
      ...
      .catch(error => {
        ...
        toast.error("Error adding attribute. Please try again.");
      });
    }
  ...
  <div className="grid gap-4 mb-4 grid-cols-2">
    <div className="col-span-2">
      ...
      />
      {errors.name && <p className="text-red-600">Attribute name is required</p>}
    </div>
    ...
    <div className="col-span-2">
      ...
      <textarea
        ...
        placeholder="Write Attribute description here"
      />
      {errors.description && <p className="text-red-600">Attribute description is required</p>}
    </div>

   

    <div className="mb-4">
                    <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Attribute Image</label>
                    <input
                      type="file"
                      id="image"
  ...
  <button onClick={() =>   toast.success("New attribute Added")} className="relative shadow inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-400 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
