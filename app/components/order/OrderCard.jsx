...
const OrderCard = ({ order }) => {
  ...
  //               <div>
  //                 <p className="text-sm font-medium text-gray-500">Date</p>
  //                 <p className="text-sm font-bold text-gray-900 mt-0.5">{new Date(order.createdAt).toLocaleDateString()}</p>
  //               </div>

  //               <div>
  //                 <p className="text-sm font-medium text-gray-500">Total Amount</p>
  //                 <p className="text-sm font-bold text-gray-900 mt-0.5">${totalAmount.toFixed(2)}</p>
  //               </div>
  ...
  //         {/* Additional parts of the component can be added here if necessary */}
  //       </div>
  //     </li>
  //   </div>
  // );
...
//   console.log(order, "we are in ordercar");

//   // Calculate the subtotal of order items if available
//   const subTotal = order?.orderItems?.reduce((total, item) => total + item.saleprice * item.qty, 0).toFixed(2);
